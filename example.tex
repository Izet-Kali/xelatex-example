...
\subsection{График по координатам}
...
\begin{figure}[H]
    ...
    \fbox{
        \begin{tikzpicture}
            ...
            \legend{$\frac{sin(x)}{x}$}%, $\frac{sin(x*x)}{x*x}$}
            \addplot[black] {sin(deg(x))/x};
            %\addplot[black] {sin(deg(x*x))/(x*x)};
...
\begin{figure}[H]
    ...
    \fbox{
        \begin{tikzpicture}
            ...
            \addplot[black] {sin(deg(x)) + (sin(deg(x*3))/3) + (sin(deg(x*5))/5) + (sin(deg(x*7))/7)};
...
\begin{figure}[H]
    ...
    \fbox{
        \begin{tikzpicture}
            ...
            \addplot[black] {sin(deg(x)) - (sin(deg(x*2))/2) + (sin(deg(x*3))/3) - (sin(deg(x*4))/4) + (sin(deg(x*5))/5) - (sin(deg(x*6))/6) + (sin(deg(x*7))/7)};
    ...
    \fbox{
        \begin{tikzpicture}
            ...
            %grid = both,
                ...
                xlabel = {$x$},
                ylabel = {$y$},
                title = {Умножать сигналы друг на друга тоже можно))},
                height = {7cm},
                width = {\linewidth},
                %xmin = 0,
                %xmax = 30,
            ...
            \addplot[red, dashed] {sin(deg(10*x))};
            \addplot[black] {sin(deg(10*x)) * sin(deg(x))};
    ...
    \fbox{
        \begin{tikzpicture}
            ...
            %grid = both,
                ...
                xlabel = {$x$},
                ylabel = {$y$},
                title = {Умножение меандра на синус},
                height = {7cm},
                width = {\linewidth},
                %xmin = 0,
                %xmax = 30,
...
{sin(deg(x))};
            \addplot[red, dashed] {(sin(deg(4*4*x))  + sin(deg(4*4*x*3))/3)  + (sin(deg(4*4*x*5))/5)  + (sin(deg(4*4*x*7))/7))};
            \addplot[black] {sin(deg(x)) * (sin(deg(4*4*x))  + sin(deg(4*4*x*3))/3)  + (sin(deg(4*4*x*5))/5)  + (sin(deg(4*4*x*7))/7))};
